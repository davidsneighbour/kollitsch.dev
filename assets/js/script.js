...
window.addEventListener('load', function () {
    ...
    jQuery('.tab-content').find('.tab-pane').each(function (idx, item) {
        var navTabs = jQuery(this).closest('.code-tabs').find('.nav-tabs'), title = jQuery(this).attr('title');
    ...
    jQuery('.nav-tabs a').click(function (e) {
        e.preventDefault();
        var tab = jQuery(this).parent(), tabIndex = tab.index(), tabPanel = jQuery(this).closest('.code-tabs'), tabPane = tabPanel.find('.tab-pane').eq(tabIndex);
