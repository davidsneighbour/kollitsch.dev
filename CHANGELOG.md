# Changelog
## [2026.0.0](https://github.com/davidsneighbour/kollitsch.dev/compare/v2025.19.0...v2026.0.0) (2025-12-14)


### ⚠ BREAKING CHANGES

* proper content handling in mdx content

### fix

* proper content handling in mdx content ([c8c7b7c](https://github.com/davidsneighbour/kollitsch.dev/commit/c8c7b7cae24529fc18f695164469e5c81c2ffd55))


### Features

* add llms structure ([ab5a2cc](https://github.com/davidsneighbour/kollitsch.dev/commit/ab5a2cc4a872406ea26b6b3c42c3f9f28bcb4e93))
...
* **gimmicks:** add dynamic selection styles ([9a43607](https://github.com/davidsneighbour/kollitsch.dev/commit/9a43607bd9ef2009251dc9d87d2a62881c25defa))
* **ogimage:** add secondary cache to ogimage creation pipeline ([01f2165](https://github.com/davidsneighbour/kollitsch.dev/commit/01f2165e6d1eaa5fa82c8cb6270184c97144c742))
* record blog content format ([#1489](https://github.com/davidsneighbour/kollitsch.dev/issues/1489)) ([bdb098e](https://github.com/davidsneighbour/kollitsch.dev/commit/bdb098ea770c4e475348cabc5e8302d6602c9521))
...
* **fix:** move image to assets directory ([57f45d9](https://github.com/davidsneighbour/kollitsch.dev/commit/57f45d90ce4e8669ee5b47f1c0f6343a81ea5368))
...
* **fix:** update image location ([a7e83c5](https://github.com/davidsneighbour/kollitsch.dev/commit/a7e83c57772cbe8ca12b171d6b23d9f39559b5a1))
* **new:** blog post of 2025-11-23 ([8167c0d](https://github.com/davidsneighbour/kollitsch.dev/commit/8167c0d6669ec9dd3f353eb29202170d639c56f2))
...
* **new:** post of 2025-11-23 ([1e1e68f](https://github.com/davidsneighbour/kollitsch.dev/commit/1e1e68f9f5e9121ca4ca35e247732d5c34bdb249))
...
* **schema:** make contentFormat optional and md by default ([0643efc](https://github.com/davidsneighbour/kollitsch.dev/commit/0643efc276945eebbacb959f36d1ab6ff52866e5))
...
* remove AGENT.md, obsolete and outdated ([9ef6387](https://github.com/davidsneighbour/kollitsch.dev/commit/9ef6387073a4cbf22adf174f2248c6723ee81134))
* update README.md and agent instructions ([cff7dde](https://github.com/davidsneighbour/kollitsch.dev/commit/cff7dde3bdc9036bc9feaa53484144e08796af32))
...
* fix TS cover type error ([#1496](https://github.com/davidsneighbour/kollitsch.dev/issues/1496)) ([ebe0a15](https://github.com/davidsneighbour/kollitsch.dev/commit/ebe0a1586df05e8574694ca4bd068a0281736785))
* fix TS error for YouTube params property ([20f3046](https://github.com/davidsneighbour/kollitsch.dev/commit/20f3046ddec4118dea6e33e293f9cd8c3955c97d))
...
* **netlify:** move functions into src directory ([80d4fda](https://github.com/davidsneighbour/kollitsch.dev/commit/80d4fdad9beece6691e32f370584d823b10e1fbb))
* **netlify:** proper error handling for email sending action ([95ccf21](https://github.com/davidsneighbour/kollitsch.dev/commit/95ccf219d0c8925956e67a2b2a6a9ff666caee5c))
* normalize open graph payload ([#1490](https://github.com/davidsneighbour/kollitsch.dev/issues/1490)) ([19d58b6](https://github.com/davidsneighbour/kollitsch.dev/commit/19d58b6afba694638b4f1fe1fb2ddd3a622198a4))
...
* various TS issues in src/components ([06f1f18](https://github.com/davidsneighbour/kollitsch.dev/commit/06f1f18801fb760c3923160b047e64d162c0516d))
...
* add tests for FeedReader component ([58e9933](https://github.com/davidsneighbour/kollitsch.dev/commit/58e9933bcc1b3eb2f8f751cb17fefa30159af382))
* disable llms test ([920c80c](https://github.com/davidsneighbour/kollitsch.dev/commit/920c80c524de144891491da0693231cebee9a263))
* fix a weird typing issue with AstroContainer ([17f4966](https://github.com/davidsneighbour/kollitsch.dev/commit/17f4966d4eb4e7233016cacc0cfbb50405d34e93))
...
* **fix:** proper path to component ([abd2f75](https://github.com/davidsneighbour/kollitsch.dev/commit/abd2f7584e5587f1095e560eced4791d9028695d))
* **fix:** remove hallucinated tests ([24d39fa](https://github.com/davidsneighbour/kollitsch.dev/commit/24d39fa08bc5bae6ba3498292c43c71b6fa707d1))
* **lighthouse:** add page speed testing ([180139d](https://github.com/davidsneighbour/kollitsch.dev/commit/180139db56bda2c92a4b8112534af25d544f975a))
* proper path to Komut component in test ([4b02348](https://github.com/davidsneighbour/kollitsch.dev/commit/4b02348e40173b8185922bc182f2993d1bdce166))


### Build System

* add build command with ogimage profiler ([5c07ae4](https://github.com/davidsneighbour/kollitsch.dev/commit/5c07ae416f8255c98f20d60ae49a21a208ca2b82))
* **ai:** move copilot instructions into copailot repo ([c5daf91](https://github.com/davidsneighbour/kollitsch.dev/commit/c5daf9162095ea623b2254d19d45f5c15b9d04b0))
* **deps:** bump @modelcontextprotocol/sdk ([#1507](https://github.com/davidsneighbour/kollitsch.dev/issues/1507)) ([1e72a03](https://github.com/davidsneighbour/kollitsch.dev/commit/1e72a03bb98b1cf3dd591df2c9043a7b3826ec2e))
...
* **deps:** update dependencies ([b64717e](https://github.com/davidsneighbour/kollitsch.dev/commit/b64717e270f60c154d94ced3372320b43fb8ae1a))
* **deps:** update dependencies ([e790c6b](https://github.com/davidsneighbour/kollitsch.dev/commit/e790c6b9e203a5fa30c42690b02c070161d9f345))
* **deps:** update dependencies ([5b515e1](https://github.com/davidsneighbour/kollitsch.dev/commit/5b515e170c6cf2ace72750614b3423012df029e9))
* **deps:** update dependencies ([b908125](https://github.com/davidsneighbour/kollitsch.dev/commit/b9081257ed5be529a99cbf160fc34c2225d8523c))
* **deps:** update dependencies ([a76cce3](https://github.com/davidsneighbour/kollitsch.dev/commit/a76cce31ec7f8fc027f4e7307e4358d98b361171))
* **deps:** update dependencies ([1594bab](https://github.com/davidsneighbour/kollitsch.dev/commit/1594bab58e45376b9284c534059e13dda33bc26e))
* **deps:** update dependencies ([37701e5](https://github.com/davidsneighbour/kollitsch.dev/commit/37701e5475683cdad8f1deeee2a752adae4fe362))
* **deps:** update dependencies ([b0f98f7](https://github.com/davidsneighbour/kollitsch.dev/commit/b0f98f75a5153adba3c6ac1cb936399ed9db45ba))
...
* **deps:** update dependencies in workflows ([0668549](https://github.com/davidsneighbour/kollitsch.dev/commit/0668549149bab0d7933ba7196caba8bea7ca0f30))
...
* **deps:** update site screenshot ([aff1f67](https://github.com/davidsneighbour/kollitsch.dev/commit/aff1f675b07d9426dd7f2ab2f946de6a9dc3e5ac))
...
* **fix:** package-lock.json broken ([099b6cf](https://github.com/davidsneighbour/kollitsch.dev/commit/099b6cfeafa2293af29b6337431f5cc70a550490))
...
* **vscode:** update workspace configuration ([661aaf4](https://github.com/davidsneighbour/kollitsch.dev/commit/661aaf42cf84b4f8f67df759a61e8a9a62f5324d))
...
* **fix:** use npm install instead of npm ci for workflow ([e3b0526](https://github.com/davidsneighbour/kollitsch.dev/commit/e3b0526c90188a9c1e47240f995ec599b5dea961))
* **lint:** add cspell setup for vscode and linting ([774609c](https://github.com/davidsneighbour/kollitsch.dev/commit/774609cd477c4f65a3eea93d6ca5574258aa3a15))
* move from npm ci to npm install to deal with npm ([09ba145](https://github.com/davidsneighbour/kollitsch.dev/commit/09ba1459480d91d4d03b4d605bfab0a4e79812d8))
...
* **deps:** update actions/checkout action to v6 ([#1494](https://github.com/davidsneighbour/kollitsch.dev/issues/1494)) ([90518fe](https://github.com/davidsneighbour/kollitsch.dev/commit/90518fe460ce76dce80fe0cde798fb7215b15f73))
...
* add test before pre-commit hooks ([aabed22](https://github.com/davidsneighbour/kollitsch.dev/commit/aabed226b6b0dc4b07fc76572fec8e56a8ec5e96))
* **ai:** add AGENTS.md file with general instructions ([86007a5](https://github.com/davidsneighbour/kollitsch.dev/commit/86007a57c02a01f9b82b4ddb64cea7c3c85bdabb))
...
* **ai:** update AGENTS.md file ([8a9b9a8](https://github.com/davidsneighbour/kollitsch.dev/commit/8a9b9a8be83d2e8c7c96c48c323fb936dee21d20))
...
* **lint:** add new biome options ([859aa0c](https://github.com/davidsneighbour/kollitsch.dev/commit/859aa0cef2571885795fc6c8b9c3def2c843c67e))
* **lint:** cleanup biome configuration ([90c44a1](https://github.com/davidsneighbour/kollitsch.dev/commit/90c44a1c6cbb1f6bf540c3cd4bde56d9a866d745))
...
* **ts:** remov alias for src directory ([ac354c4](https://github.com/davidsneighbour/kollitsch.dev/commit/ac354c49bd943c4217fe95e5b1493e12b364eabb))
* **workspace:** handle AGENT(S).md properly in file nesting ([a216850](https://github.com/davidsneighbour/kollitsch.dev/commit/a216850de3b035393855e096163229890a558a5f))
