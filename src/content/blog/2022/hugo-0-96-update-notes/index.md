...
The [hmac](https://gohugo.io/functions/crypto/hmac/) function creates a cryptographic hash from input by using a key.
...
* `.File.Extension` on the page object was deprecated. This was [never documented](https://gohugo.io/methods/page/file/). Use `File.Ext` instead.
