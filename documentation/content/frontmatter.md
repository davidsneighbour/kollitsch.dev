...
| `fmContentType` | no | `string` | Optional Front Matter CMS content-type marker. |
...
| `options.head.components` | no | `lite-youtube[]`, `color-grid[]`, `date-diff[]` | Extra head components required by a post. |
